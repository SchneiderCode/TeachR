...
#' questions. This is a modified version of the one provided by the LearnR package.
#'
#' @examples
#' tutorial()
#'
...
#' @param server_url The url for the tutorial's associated server
...
tutorial <- function(
  ...
  extra_dependencies <- append(extra_dependencies, list(
    ...
    htmltools::htmlDependency(
      ...
      version = utils::packageVersion("teachr"),
      src = system.file("rmarkdown/templates/tutorial/resources", package = "teachr"),
  ...
  args <- c(
    args,
    rmarkdown::pandoc_variable_arg("server_url", server_url),
